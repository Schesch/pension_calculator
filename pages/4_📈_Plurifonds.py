...
if sprache == "Deutsch":
    ...
    if typ == "Kollektivvertraglich":
        ...
        url_kv = "https://www.pensplan.com/de/download/beobachtungsstelle-kollektivvertraege.asp"
        st.markdown("Informationen zu den Kollektivverträgen finden Sie hier: [Pensplan Kollektivverträge](%s)" % url_kv)
    ...
    if typ == "Kollektivvertraglich":
        ...
        * Bruttoeinkommen im ersten Jahr: {income}€
        * Arbeitnehmer Beitrag: {an_beitrag}%
        * Abfertigung pro Quartal zu Beginn: {tfr_beitrag}€
    ...
    if typ == "Base Collettiva":
        ...
        url_kv = "https://www.pensplan.com/de/download/beobachtungsstelle-kollektivvertraege.asp"
        st.markdown("Per informazioni sui contratti collettivi, clicca qui: [Contratti Collettivi Pensplan](%s)" % url_kv)
    ...
    if typ == "Base Collettiva":
        ...
        st.markdown("Le contribuzioni iniziano nel primo mese del rispettivo trimestre.") 
    elif typ == "Individuale":
        # Create three columns
        date1, date2 = st.columns(2)
        # Place each widget in its respective column
