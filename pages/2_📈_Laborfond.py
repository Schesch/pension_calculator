...
if sprache == 'Deutsch':
    ...
    excel_path = '/Users/schesch/Desktop/pp/data/Laborfond.xlsx'
    ...
    * Abfertigung Beitrag pro Quartal: {tfr_beitrag}€
    * Gesamte Einzahlung pro Quartal: {einzahlung}€
    ...
    * Für die Vorsichtig-Ethische Linie: ab Q2 2008
    ...
    st.subheader("TFR")
    st.markdown("Il TFR corrisponde al 6,91% dello stipendio lordo e può essere versato aggiuntivamente.")
    tfr = st.selectbox(
    ...
    * Versamento del TFR trimestrale: {tfr_beitrag}€
    * Versamento totale trimestrale: {einzahlung}€
