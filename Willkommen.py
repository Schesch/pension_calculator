...
if sprache == "Deutsch":
    ...
    st.title("Willkommen")
    st.subheader("zum Online Tool zur Simulation der Beitragsentwicklung für die regionalen Zusatzrentenfonds in Trentino-Südtirol")

    st.markdown("Dieser Online Simulator ermöglich es Ihnen die drei großen Pensionsfonds in der Region Trentino Südtirol und die Performance der einzelnen Investitionslinien zu vergleichen.")
    ...
    st.markdown("Wegen der Veröffentlichungspflicht der Rentenfonds konnten die Daten von den Webseiten der jeweiligen Pensionsfonds selbst entnommen werden.")
    ...
    st.title("Benvenuto")
    st.subheader("al dashboard online per la simulazione dell'evoluzione dei contributi per i fondi pensione complementari regionali in Trentino Alto-Adige.")

    st.markdown("Questo simulatore online vi permette di confrontare i tre grandi fondi pensione nella regione Trentino Alto Adige e la performance delle singole linee di investimento.")
