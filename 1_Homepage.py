...
if sprache == "Deutsch":
    ...
    st.markdown("Dieser Online Rechner ermöglich es Ihnen die Performance der einzelnen Investitionslinien von den Pensionsfonds in der Region Trentino Südtirol zu vergleichen.")
